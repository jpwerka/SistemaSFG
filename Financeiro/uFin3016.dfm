inherited Fin3016: TFin3016
  Caption = 'Consulta de Pagamento x Fornecedor'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited HeaderPanel: TPanel
    Caption = 'Pagamento x Fornecedor'
  end
  inherited BodyPanel: TPanel
    ...
    object gbFiltros: TGroupBox
      ...
      object btPesqFornecedor: TResBitBtn
        ...
        Width = 23
        Height = 23
        Hint = 'Abre a pesquisa de Fornecedors.'
  ...
  object SfgToolbar: TPanel
    ...
    object btRelatorio: TResBitBtn
      ...
      Height = 32
      Hint = 
        'Visualiza a listagem das contas '#224' pagar| x parcelas de acordo co' +
        'm as op'#231#245'es escolhidas.'
      TabOrder = 0
