inherited Fin1003: TFin1003
  ...
  object btRecContaReceber: TResBitBtn
    Left = 538
    Top = 61
    Width = 32
    Height = 32
  ...
  object QyContaReceber: TZQuery
    Connection = SfgDataCenter.AppConnection
    AfterOpen = QyContaReceberAfterOpen
    BeforeClose = QyContaReceberBeforeClose
    AfterScroll = QyContaReceberAfterScroll
    BeforePost = QyContaReceberBeforePost
    AfterPost = QyContaReceberAfterPost
    BeforeDelete = QyContaReceberBeforeDelete
    OnPostError = QyContaReceberPostError
    SQL.Strings = (
      
        'SELECT cod_conta_receber, cod_cliente, data_cadastro, num_docume' +
        'nto, ies_situacao,'
      '       tipo_registro, cod_centro_custo, cod_plano_conta,'
      '       cod_forma_pagto, num_parcelas, valor_total, observacao'
      '   FROM tbl_conta_receber ORDER BY cod_conta_receber')
    Params = <>
    Left = 600
    Top = 12
  end
  ...
  object AddPagto: TZUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO tbl_conta_receber_pagto '
        ...
        '  (cod_conta_receber ,seq_parcela, valor_parcela, data_venciment' +
        'o, '
      'ies_recebido,  observacao)'
      'VALUES'
      
        '  (:cod_conta_receber ,:seq_parcela, :valor_parcela, :data_venci' +
        'mento, '
      #39'N'#39',:observacao)')
    ModifySQL.Strings = (
  ...
  object ActionList1: TActionList
    Left = 720
    Top = 66
    object execVisualizaRecbto: TAction
      Enabled = False
      Hint = 'Visualiza o recebimento da conta.'
      ShortCut = 16463
      OnExecute = btRecContaReceberClick
    end
