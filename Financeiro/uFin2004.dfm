inherited Fin2004: TFin2004
  Caption = 'An'#225'lise de Contas '#224' Receber'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited HeaderPanel: TPanel
    Caption = 'An'#225'lise Contas '#224' Receber'
  end
  ...
  object SfgToolbar: TPanel
    ...
    object btProcessar: TResBitBtn
      ...
      Height = 32
      Hint = 
        'Visualiza uma an'#225'lise detalhada das contas '#224' receber|em uma tabe' +
        'la din'#226'mica carregada via Excel.'
      TabOrder = 0
