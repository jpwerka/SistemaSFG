inherited Fin3010: TFin3010
  ...
  inherited RpRelatBase: TfrxReport
    ...
    Datasets = <
      item
        DataSet = frxQyCntContaReceber
        DataSetName = 'QyCntContaReceber'
      end
      item
    ...
    inherited Page1: TfrxReportPage
      ...
      inherited Child1: TfrxChild
        ...
        inherited Titulo: TfrxMemoView
          Width = 718.1107
          Memo.UTF8 = (
            'Conta Cont'#195#161'bil x Contas '#195#160' Receber')
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Condition = 'QyCntContaReceber."cod_plano_conta"'
        object Memo5: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[QyCntContaReceber."cod_plano_conta"] - [QyContaContabil."den_pl' +
              'ano_conta"]')
          WordWrap = False
        end
      end
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo13: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[QyCntContaReceber."cod_conta_receber"]')
        end
        object Memo14: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[QyCntContaReceber."data_cadastro"]')
          WordWrap = False
        end
        object Memo15: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[QyCntContaReceber."valor_recebido"]')
        end
        ...
        object Memo17: TfrxMemoView
          ...
          DataSetName = 'QyCntContaReceber'
          Memo.UTF8 = (
            '[QyCntContaReceber."den_situacao"]')
          WordWrap = False
        end
        object Memo18: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[QyCntContaReceber."cod_centro_custo"]')
        end
        object Memo19: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[QyCntContaReceber."cod_cliente"] - [QyCntContaReceber."den_clie' +
              'nte"]')
        end
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo20: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<QyCntContaReceber."valor_total">)]')
        end
        ...
        object Memo22: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<QyCntContaReceber."valor_recebido">)]')
        end
  ...
  object QyCntContaReceber: TZReadOnlyQuery
  ...
  object DsCctPedidoCompra: TDataSource
    DataSet = QyCntContaReceber
    Left = 48
    Top = 6
  end
  object frxQyCntContaReceber: TfrxDBDataset
    UserName = 'QyCntContaReceber'
