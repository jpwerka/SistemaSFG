inherited Fin3002: TFin3002
  ...
  inherited HeaderPanel: TPanel
    Caption = 'Consulta Contas '#224' Pagar'
  end
  ...
  object SfgToolbar: TPanel
    ...
    object btRelatorio: TResBitBtn
      ...
      Height = 32
      Hint = 
        'Visualiza a listagem das contas '#224' pagar de|acordo com o agrupame' +
        'nto e as op'#231#245'es escolhidas.'
      TabOrder = 0
