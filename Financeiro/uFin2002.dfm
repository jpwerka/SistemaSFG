inherited Fin2002: TFin2002
  Caption = 'An'#225'lise de Contas '#224' Pagar'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited HeaderPanel: TPanel
    Caption = 'An'#225'lise Contas '#224' Pagar'
  end
  ...
  object SfgToolbar: TPanel
    ...
    object btProcessar: TResBitBtn
      ...
      Height = 32
      Hint = 
        'Visualiza uma an'#225'lise detalhada das contas '#224' pagar|em uma tabela' +
        ' din'#226'mica carregada via Excel.'
      TabOrder = 0
