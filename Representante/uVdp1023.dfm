inherited Vdp1023: TVdp1023
  ...
  inherited BodyPanel: TPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object btObs: TResBitBtn
        ...
        Width = 24
        Height = 24
        Hint = 'Incluir uma observa'#231#227'o para o representante.'
        TabOrder = 3
        OnClick = btObsClick
    ...
    object grpInfo: TGroupBox
      ...
      object Label3: TLabel
        ...
        FocusControl = den_representante
        Transparent = True
        WordWrap = True
      end
      ...
      object perc_comissao: TDBEdit
        ...
        DataSource = DsCadRepresentante
        TabOrder = 6
        OnKeyPress = perc_comissaoKeyPress
      end
    end
  ...
  object QyCadRepresentante: TZQuery
    Connection = SfgDataCenter.AppConnection
    AfterScroll = QyCadRepresentanteAfterScroll
    SQL.Strings = (
      
        'SELECT cod_representante, den_representante, nome_fantasia, ies_' +
        'ativo,'
      
        '       tipo_pessoa, cpf_cnpj, rg_ie, data_nasc_fund, perc_comiss' +
        'ao,'
  ...
  object DsCadRepresentante: TDataSource
    AutoEdit = False
    DataSet = QyCadRepresentante
    Left = 656
    Top = 8
  end
