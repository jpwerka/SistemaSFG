object Vdp2021: TVdp2021
  Left = 0
  Top = 0
  Width = 774
  Height = 544
  HorzScrollBar.Visible = False
  Caption = 'Telefones dos Representantes'
  Color = clWhite
  ...
  object GrdFoneRepresentante: TDBGrid
    Left = 0
    Top = 0
    Width = 766
    Height = 476
    Align = alClient
    DataSource = DsFoneRepresentante
  ...
  object QyFoneRepresentante: TZQuery
    ...
    Left = 120
    Top = 112
    object QyFoneRepresentantecod_representante: TStringField
      FieldName = 'cod_representante'
      Size = 15
    end
    object QyFoneRepresentanteden_representante: TStringField
      FieldName = 'den_representante'
      Size = 50
    end
    object QyFoneRepresentantetelefone: TStringField
      FieldName = 'telefone'
      EditMask = '!\(999\) 0000-0000;0;_'
      Size = 15
    end
    object QyFoneRepresentantecelular: TStringField
      FieldName = 'celular'
      EditMask = '!\(999\) 0000-0000;0;_'
      Size = 15
    end
    object QyFoneRepresentantefax: TStringField
      FieldName = 'fax'
      EditMask = '!\(999\) 0000-0000;0;_'
      Size = 15
    end
  end
  object DsFoneRepresentante: TDataSource
    AutoEdit = False
