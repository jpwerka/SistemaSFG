...
//---------------------------------------------------------------------------
__fastcall TVdp1004::TVdp1004(TComponent* Owner)
	: TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TVdp1004::FormClose(TObject *Sender, TCloseAction &Action)
{
	int i;
	int *iCodFamilia;
...
//---------------------------------------------------------------------------
void __fastcall TVdp1004::LimpaItemObjects(TListBox *Lista)
{
	int i;
...
//---------------------------------------------------------------------------
void __fastcall TVdp1004::cbFamiliaChange(TObject *Sender)
{
	int *iCodFamilia;
	SelProdutos *pListProdutos;
	String sText;
...
//---------------------------------------------------------------------------
void __fastcall TVdp1004::btAddClick(TObject *Sender)
{
	int i;
	float fQtdProduto = 0;
...
//---------------------------------------------------------------------------
void __fastcall TVdp1004::edtQtdKeyPress(TObject *Sender, char &Key)
{
	Validacoes::ValidarFloat(edtQtd->Text, Key);
}
//---------------------------------------------------------------------------
void __fastcall TVdp1004::btRemoveClick(TObject *Sender)
{
	int i;
...
//---------------------------------------------------------------------------
void __fastcall TVdp1004::btOKClick(TObject *Sender)
{
	int i;
