inherited Vdp1001: TVdp1001
  ...
  inherited BodyPanel: TPanel
    object gbCadastro: TGroupBox
      ...
      object cod_pedido_venda: TDBEdit
        Left = 48
        Top = 15
        Width = 70
        Height = 21
  ...
  object QyCadProduto: TZQuery
    ...
    object QyCadProdutocod_pedido_venda: TIntegerField
  ...
  object QyCadPagto: TZQuery
    ...
    BeforeInsert = QyDetalheBeforeInsert
    SQL.Strings = (
      'SELECT cod_pedido_venda, seq_parcela, '
      '       valor_parcela, data_vencimento, observacao, ies_recebido'
    ...
    object QyCadPagtocod_pedido_venda: TIntegerField
      DisplayWidth = 10
      FieldName = 'cod_pedido_venda'
  ...
  object AddItemVenda: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM tbl_pedido_venda_item'
      'WHERE cod_pedido_venda = :cod_pedido_venda '
      'AND seq_produto = :seq_produto')
    InsertSQL.Strings = (
      'INSERT INTO tbl_pedido_venda_item '
      '(cod_pedido_venda, seq_produto, cod_produto, qtd_produto, '
      'preco_venda,val_desconto) '
      'VALUES '
      '(:cod_pedido_venda, :seq_produto, :cod_produto, :qtd_produto, '
      ':preco_venda,:val_desconto)')
    ModifySQL.Strings = (
      'UPDATE tbl_pedido_venda_item SET'
  ...
  object AddPagto: TZUpdateSQL
    DeleteSQL.Strings = (
      'DELETE FROM tbl_pedido_venda_pagto'
      'WHERE cod_pedido_venda = :cod_pedido_venda'
      'AND seq_parcela = :seq_parcela')
    InsertSQL.Strings = (
      'INSERT INTO tbl_pedido_venda_pagto '
      '(cod_pedido_venda, seq_parcela, valor_parcela, data_vencimento, '
      'ies_recebido, observacao) '
      'VALUES '
      
        '(:cod_pedido_venda, :seq_parcela, :valor_parcela, :data_vencimen' +
        'to, '#39'N'#39', '
      ':observacao)')
    ModifySQL.Strings = (
      'UPDATE tbl_pedido_venda_pagto SET'
  ...
  object QyCadVenda: TZQuery
    Connection = SfgDataCenter.AppConnection
    AutoCalcFields = False
    AfterOpen = QyCadVendaAfterOpen
    BeforeClose = QyCadVendaBeforeClose
    AfterScroll = QyCadVendaAfterScroll
    OnCalcFields = QyCadVendaCalcFields
    AfterInsert = QyCadVendaAfterInsert
    BeforePost = QyCadVendaBeforePost
    AfterPost = QyCadVendaAfterPost
    BeforeDelete = QyCadVendaBeforeDelete
    OnPostError = QyCadVendaPostError
    SQL.Strings = (
      'SELECT cod_pedido_venda, cod_cliente, data_cadastro,'
      
        #9#9' ies_situacao, cod_plano_conta, cod_centro_custo, cod_represen' +
        'tante,'
      '       cod_forma_pagto, num_parcelas, valor_total, observacao'
      '  FROM tbl_pedido_venda'
      ' ORDER BY cod_pedido_venda')
    Params = <>
    Left = 696
    Top = 8
  end
  object ActionList1: TActionList
    ...
    object execRelatorio: TAction
      Enabled = False
      Hint = 'Visualiza a impress'#227'o do pedido de venda.'
      ShortCut = 16457
    ...
    object execFechamento: TAction
      Enabled = False
      Hint = 
        'Fecha o pedido de venda efetuando a sa'#237'da|do estoque e a integra' +
        #231#227'o com o contas a receber.'
      ShortCut = 16454
      OnExecute = btFechamentoClick
    end
    object execImportar: TAction
      Hint = 'Importa um or'#231'amento para um pedido de venda.'
      ShortCut = 16463
