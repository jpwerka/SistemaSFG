inherited Vdp3007: TVdp3007
  ...
  inherited RpRelatBase: TfrxReport
    ...
    ReportOptions.LastChange = 41213.9721712153
    Datasets = <
      item
    ...
    inherited Page1: TfrxReportPage
      ...
      inherited Child1: TfrxChild
        ...
        inherited Titulo: TfrxMemoView
          Width = 718.1107
          Memo.UTF8 = (
            'Representante x Pedidos de Venda')
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Condition = 'QyForPedidoVenda."cod_representante"'
        object Memo5: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[QyForPedidoVenda."cod_representante"] - [QyForPedidoVenda."den_' +
              'representante"]')
          WordWrap = False
        end
      end
