...
#include <Buttons.hpp>
//---------------------------------------------------------------------------
struct TBDVdp1001Object : public TBDDataObject {
  bool ies_parcelado;
  bool ies_financeiro;
};
//---------------------------------------------------------------------------
class SfgWorkEdition;
class TVdp1001 : public TfrmBase02
{
__published:	// IDE-managed Components
	TZQuery *QyCadVenda;
   TDataSource *DsCadVenda;
   ...
   TZQuery *QyCliente;
	...
	TIntegerField *QyCadPagtocod_pedido_venda;
	TIntegerField *QyCadPagtoseq_parcela;
	TIntegerField *QyCadProdutocod_pedido_venda;
   ...
   TResBitBtn *btPesqRepresentante;
	...
	void __fastcall QyCadVendaAfterScroll(TDataSet *DataSet);
	void __fastcall QyCadVendaAfterPost(TDataSet *DataSet);
	void __fastcall QyCadVendaBeforePost(TDataSet *DataSet);
	void __fastcall QyCadVendaBeforeDelete(TDataSet *DataSet);
	...
	void __fastcall QyCadVendaCalcFields(TDataSet *DataSet);
   ...
   void __fastcall QyCadVendaPostError(TDataSet *DataSet,
          EDatabaseError *E, TDataAction &Action);
   void __fastcall TipoPessoaChange(TField *Sender);
   void __fastcall QyCadVendaAfterOpen(TDataSet *DataSet);
   void __fastcall QyCadVendaBeforeClose(TDataSet *DataSet);
   void __fastcall QyCadVendaAfterInsert(TDataSet *DataSet);
private:	// User declarations
   ...
   bool __fastcall VerificaClientAtraso(String CodCliente);
public:		// User declarations
	SfgWorkEdition *pWorkEdtCliente; //Trabalha a lista de campos habilitando-os quando necessário
	__fastcall TVdp1001(TComponent* Owner);
	void __fastcall FilterCodVenda(int CodVenda);
