inherited Vdp2001: TVdp2001
  Caption = 'An'#225'lise de Pedidos de Venda'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited HeaderPanel: TPanel
    Caption = 'An'#225'lise Pedidos de Venda'
  end
  ...
  object SfgToolbar: TPanel
    ...
    object btProcessar: TResBitBtn
      ...
      Height = 32
      Hint = 
        'Visualiza uma an'#225'lise detalhada das vendas|em uma tabela dinamic' +
        'a carregada via Excel.'
      TabOrder = 0
