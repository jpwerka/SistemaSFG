...
__published:    // IDE-managed Components
        ...
        TButton *Z;
        TButton *TODOS;
        TDBGrid *GrdFoneFornec;
        TZQuery *QyFoneFornec;
        TDataSource *DsFoneFornec;
        TResBitBtn *BtRelat;
	TStringField *QyFoneForneccod_fornec;
	TStringField *QyFoneFornecden_fornec;
	TStringField *QyFoneFornectelefone;
	TStringField *QyFoneForneccelular;
	TStringField *QyFoneFornecfax;
...
public:		// User declarations
        __fastcall TSup2020(TComponent* Owner);
};
//---------------------------------------------------------------------------
#endif
