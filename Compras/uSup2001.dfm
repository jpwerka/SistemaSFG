inherited Sup2001: TSup2001
  Caption = 'An'#225'lise de Pedidos de Compra'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited HeaderPanel: TPanel
    Caption = 'An'#225'lise Pedidos de Compra'
  end
  ...
  object SfgToolbar: TPanel
    ...
    object btRelatorio: TResBitBtn
      ...
      Height = 32
      Hint = 
        'Visualiza uma an'#225'lise detalhada das compras|em uma tabela dinami' +
        'ca carregada via Excel.'
      TabOrder = 0
